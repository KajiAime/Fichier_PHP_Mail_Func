...
if($email){
    ...
    echo "<h2>L'addresse email est incorrect. S'il vous plait, corriger l'addresse avant d'envoyer le message.</h2>"."\r\n";
}
?>
<html>
    <head>
    ...
    <body>
        <?php if(isset($sent) && $sent){?>
            ...
            <?php }else{?>
                <h1><?php echo "Erreur: Message non envoyer. Veuillez reessayer.";?></h1>
            <?php }?>
